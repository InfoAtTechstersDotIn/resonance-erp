...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Student Voucher Discount Report
                </h2>
            </div>
        </div>
        <!--<form id="filterForm">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <b>Branch Name:</b> <?php echo $result->branchname ?><br />
                                             <b>Requested Amount: </b> <?php echo $result->requestedamount ?><br />
                                             <?php if($result->status==1)
                                                 {
                                                     ?>
                                                     <b>Approved Amount:</b> <?php echo $result->approvedamount ?><br />                                                     
                                                     <?php
                                                 }
                                                 ?>
                                             <b>Comments: </b> <?php echo $result->reason ?><br />
                                             <b>Voucher Type: </b> <?php echo $result->vouchertype;?><br>
                                             <b>Voucher Id: </b> <?php echo $result->reservation_discountid;?>
                                            </td>
                                             <td>
...
<script>
    function filter(download = 0) {
        var URL = "<?php echo base_url('reports/report_studentdiscount') ?>" + "?" + $('#filterForm').serialize();
