<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Profile Image Pending Report
                </h2>
            </div>
        </div>
        <form id="filterForm">
...
<script>
    function filter(download = 0) {
        var URL = "<?php echo base_url('reports/report_profileimage') ?>" + "?" + $('#filterForm').serialize();
