<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Reservation Daily Collection Report
                </h2>
            </div>
        </div>
        <form id="filterForm">
                        ...
                        <table class="DataTable table table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td>
                                                <b>Reservation Number:</b> <?php echo $result->reservation_ukey ?><br />
...
<script>
    function filter(download = 0) {
        var URL = "<?php echo base_url('reports/report_reservationcollectiondetails') ?>" + "?" + $('#filterForm').serialize();
