                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-success" <?php  if ($result->TotalPaid >= $result->TotalValue) : ?> href="<?php echo base_url('forms/noDueCertificate?userId=') . $result->userid ?>" <?php else:?>  disabled <?php endif;?> onclick="printDiv('div')">Print</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
