    ...
    <div class="ts-main-content">
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 style="text-align: center; background-color: #99cc33; color: white;"><strong>Scholarship Voucher</strong></h1>
                               <br>
                                ...
                                <table style="width: 100%; margin-left: auto; margin-right: auto;">
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td style="background-color: #99cc33; border: 1px solid #99cc33;"><b>Amount</b></td>
                                            <td style="border: 1px solid #99cc33;"><i><?php echo $payment[0]->paymentamount ?></i></td>
                                        </tr>
                                     
                                        <tr>
                                            <td style="background-color: #99cc33; border: 1px solid #99cc33;"><b>Approved Date</b></td>
                                            <td style="border: 1px solid #99cc33;"><i><?php echo $payment[0]->approved_date;?></i></td>
                                        </tr>
                                        <tr>
                                            <td style="background-color: #99cc33; border: 1px solid #99cc33;"><b>Discount Approved By</b></td>
                                            <td style="border: 1px solid #99cc33;"><i><?php echo $payment[0]->receivedby;?></i></td>
                                        </tr>
                                        <tr>
                                            <td style="background-color: #99cc33; border: 1px solid #99cc33;"><b>Academic Year</b></td>
                                            <td style="border: 1px solid #99cc33;"><i><?php echo $payment[0]->batchname;?></i></td>
                                        </tr>
                                        <tr>
                                            <td style="background-color: #99cc33; border: 1px solid #99cc33;"><b>S Voucher No</b></td>
                                            <td style="border: 1px solid #99cc33;"><i><?php echo $payment[0]->reservation_discountid;?></i></td>
                                        </tr>
