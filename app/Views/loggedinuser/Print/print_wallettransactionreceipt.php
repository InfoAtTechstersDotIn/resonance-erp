    ...
    <div class="ts-main-content">
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 style="text-align: center; background-color: #99cc33; color: white;"><strong>Wallet Transaction Receipt</strong></h1>
                ...
                <table style="width: 75%; margin-left: auto; margin-right: auto;">
                    <tbody>
                        <tr>
                            <td style="background-color: #99cc33; width: 20%; text-align: center; border: 1px solid #99cc33;"><strong>Wallet Type</strong></td>
                        ...
                        <tr>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->wallettypename ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo date_format(date_create($WalletTransaction->date), 'd/m/Y'); ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->transactiontype ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->amount ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->name ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->payment_details ?></td>
                            <td style="width: 20%; text-align: center; border: 1px solid #99cc33;"><?php echo $WalletTransaction->remarks ?></td>
                        </tr>
                    </tbody>
                </table>
