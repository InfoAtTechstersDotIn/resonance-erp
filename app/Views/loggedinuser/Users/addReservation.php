        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" id="reservationform" action="<?php
                                                                    ...
                                                                    echo base_url('users/createreservation') ?>">
                    ...
                    <div class="tab-content tab-validate">
                        <div id="reservation" class="tab-pane fade in active">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="reservationid" id="reservationid" class="form-control formfield" required>
                                    <br />
                                    <br />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" onchange="this.classList.remove('error')" placeholder="dd/mm/yy" id="admissiondate" name="admissiondate" class="form-control mb datepicker" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div id="basic" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Name" id="visitorname" name="visitorname" class="form-control mb">

                                </div>
                                <div class="col-md-6">
                                <label class="text-uppercase text-sm">Relationship with student</label>
                                    <input type="text" placeholder="Relation with student" id="relationwithstudent" name="relationwithstudent" class="form-control mb">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="text-uppercase text-sm">Visitor Mobile Number</label>
                                    <input type="text" placeholder="Visitor Phone Number" id="visitornumber" name="visitornumber" class="form-control mb">
                        ...
                        <div id="fees" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="text-uppercase text-sm">Tuition Fees</label>
                                ...
                                <div class="col-md-3">
                                    <label class="text-uppercase text-sm">Discount Requested</label>
                                    <input type="number" min="0" max="0" value="0" id="discountrequested" name="discountrequested" title="Maximum discount is 0" class='form-control mb' />
                                </div>
                                <div class="col-md-3">
                        ...
                        <div id="payment" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="text-uppercase text-sm">Reservation Fees</label>
                                ...
                                <div class="col-md-6">
                                    <label class="text-uppercase text-sm">Reservation Amount</label>
                            ...
                            <div class="row">
                                <!-- <div class="col-md-6">
                                    <label class="text-uppercase text-sm">Reservation Date</label>
                        ...
                        <div id="preview" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <button type="submit" name="createstudent" class="btn btn-primary">Create Reservation</button>
                                </div>
                                <div class="col-md-3">
    ...
    <script>
        ...
        function changeFeesBasedOnCourse() {
            ...
            if (admissiontype_id == 1) {
                $('#discountrequested').attr("max", 90000);
                $('#discountrequested').attr("title", "Maximum discount should be under 90000");

            } else if (admissiontype_id == 2) {
                $('#discountrequested').attr("max", 75000);
                $('#discountrequested').attr("title", "Maximum discount should be under 75000");
            } else if (admissiontype_id == 3) {
                $('#discountrequested').attr("max", 75000);
                $('#discountrequested').attr("title", "Maximum discount should be under 75000");
            } else {
                $('#discountrequested').attr("max", 0);
                $('#discountrequested').attr("title", "Maximum discount is 0");
            }
