...
<body>
  <div class="container mt-5">
      ...
      <div>
          ...
          <b>Application Number</b> :  <?php print_r($application[0]->reservation_ukey);?><br>
      ...
      <br>
    <form method="post" action="<?php echo base_url('users/updatereservationstudentprofileimage/'.$userid);?>" enctype="multipart/form-data" >
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <input type="text" name="dateofbirth" id="dateofbirth" class="form-control" placeholder='dd-mm-yyyy'>
      </div>
      <div class="form-group">
