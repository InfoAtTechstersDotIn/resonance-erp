            ...
            <div class="col-md-12">
                ...
                <form method="post" id="studentform" action="<?php
                        ...
                        <div id="basic" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Name" id="name" name="name" class="form-control mb" value="<?php echo $StudentDetail->name ?>" >

                                </div>
                                <div class="col-md-6">
                                    <label class="text-uppercase text-sm">Date Of Birth<i style="color: red;">*</i></label>
                                    <input onchange="this.classList.remove('error')" type="text" placeholder="dd/mm/yy" id="dateofbirth" name="dateofbirth" class="form-control mb datepicker" value="<?php echo date_format(date_create($StudentDetail->dateofbirth), 'd/m/Y') ?>" >
                                </div>
                            </div>
                        ...
                        <div id="education" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select onchange="this.classList.remove('error')" id="board" name="board" style="width: 100%;" class="select2 form-control mb" >
                                    <?php
                        ...
                        <div id="contact" class="tab-pane fade">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select onchange="this.classList.remove('error');getdistricts_perm(this.value);" id="state" name="state" style="width: 100%;" class="select2 form-control mb" >
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select onchange="this.classList.remove('error')" id="district" name="district" style="width: 100%;" class="select2 form-control mb" >
                        ...
                        <div id="fees" class="tab-pane fade">
                            ...
                            <br>
                              ...
                              $TotalPaid=0;
                                    ...
                                    if ($TotalValue == $TotalPaid) {
                                        ?>
                                        <input type="hidden" value=0 name="lastyeardues" id="lastyeardues">
                                        <input type="hidden" value=0 name="lastyearrefunds" id="lastyearrefunds">
                                        <?php
                                    }
                                    elseif($TotalPaid > $TotalValue)
                                    {
                                        echo "Note:".abs($RemainingAmount)." will be carry forward
                                        last year Refund";
                                        ?>
                                        <input type="hidden" value="<?php echo abs($RemainingAmount);?>" name="lastyearrefunds" id="lastyearrefunds">
                                        <input type="hidden" value=0 name="lastyeardues" id="lastyeardues">
                                        <?php
                                    }
                                    else
                                    {
                                        echo "Note:".$RemainingAmount." will be carry forward
                                        last year dues";
                                         ?>
                                        <input type="hidden" value="<?php echo $RemainingAmount;?>" name="lastyeardues" id="lastyeardues">
                                        <input type="hidden" value=0 name="lastyearrefunds" id="lastyearrefunds">
                                        <?php
                                    }
                        ...
                        <div id="preview" class="tab-pane fade">
                            ...
                            <div id="print_preview1" style="display:none; border:1px solid black;">
                                ...
                                justify-content: center; width:50%; margin-left:auto; margin-right:auto;">STUDENT ONBOARDING FORM</th>
                                    ...
                                    <tr style="display:flex;">
                                        <td style="width: 100%;  border:1px solid #edebe6;border: 1px solid #edebe6;display: flex;justify-content: space-between;"><span style="width: 50%;">At the time of reporting(50%): </span> <b style="margin-right: auto;"><span id="preview_reporting"></span></b></td>
                    ...
                    <input type="hidden" id="ipefee" name='ipefee'  />
                     <input type='hidden' id='ipefeeafterdiscount' name='ipefeeafterdiscount' value="<?php echo $StudentDetail->secondyearipefee ?>">
                    <input type='hidden' id='hostelfeeafterdiscount' name='hostelfeeafterdiscount' value="<?php echo $StudentDetail->secondyearhostelfee ?>" >
    ...
    <script>
        ...
        function generatePreview() {
          var fakeURL = "http://www.example.com/t.html?" + $('#studentform').serialize();
            ...
            $('#preview_reporting').html(Math.abs((((parseFloat($('#text_tuition_fees_total').val()) + parseFloat($('#text_hostel_fees_total').val()) + parseFloat($('#text_ipe_fees_total').val()) + parseFloat(actualMiscellaneousFee))/2 + parseFloat($('#lastyeardues').val()))) - parseFloat($('#lastyearrefunds').val())));
            $('#preview_1st').html((parseFloat($('#text_tuition_fees_total').val()) + parseFloat($('#text_hostel_fees_total').val()) + parseFloat($('#text_ipe_fees_total').val()) + parseFloat(actualMiscellaneousFee))/4);
           $('#preview_2nd').html((parseFloat($('#text_tuition_fees_total').val()) + parseFloat($('#text_hostel_fees_total').val()) + parseFloat($('#text_ipe_fees_total').val()) + parseFloat(actualMiscellaneousFee))/4);
                    ...
                    if (a.courseid == course_id && a.admissiontypeid == admissiontype_id && a.batchid == batch_id) {
                       if (a.feetype == "Tuition Fee") {
                        ...
                        if (a.feetype == "Uniform") {
                            fees += "<div class='row'><div class='col-md-4'> Practicals fee </div><div class='col-md-4'>" + a.feesvalue + "</div><div class='col-md-4'>&nbsp;</div></div>";
                            actualMiscellaneousFee += parseFloat(a.feesvalue);
                        }
        ...
        function change(admissiontype_id) {
            ...
            //$('#text_hostel_fees_total').val($('#hostelfee').val() - $('#discountgiven').val());
             $('#text_hostel_fees_total').val(parseFloat($('#hostelfeeafterdiscount').val()));
            }else
            {
            var ms = parseFloat($('#meritscholarship').html()) + parseFloat($('#meritinterviewscholarship').html());
              ...
              $('#text_ipe_fees_total').val(parseFloat($('#ipefeeafterdiscount').val()));
                $('#text_hostel_fees_total').attr("min", 0);
                $('#text_hostel_fees_total').attr("max", actualHostelFee);
