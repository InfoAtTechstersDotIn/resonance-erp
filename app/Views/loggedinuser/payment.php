                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a title="View" target="_blank" href="<?php echo base_url('payments/generatereceipt') ?>?paymentid=<?php echo $result->paymentid ?>&type=view"><i class="fa fa-eye"></i></a>&nbsp;
                                            <a title="Download" href="<?php echo base_url('payments/generatereceipt') ?>?paymentid=<?php echo $result->paymentid ?>&type=download"><i class="fa fa-download"></i></a>&nbsp;
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="<?php echo base_url('payments/addpayment') ?>">
                                <br>
                                <div class="row">
                                    <div class="col-md-6">
