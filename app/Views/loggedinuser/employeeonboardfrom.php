        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form method="post" id="reservationform" enctype="multipart/form-data"  action="<?php
                                                                    ...
                                                                    echo base_url('users/updateonboardemployee') ?>">
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Aadhaar Number" id="aadhaar" name="aadhaar" class="form-control mb" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="text-uppercase f-16">Pan Card Number<i style="color: red;">*</i></label>
                                    <input type="text" placeholder="Aadhaar Number" id="pancard" name="pancard" class="form-control mb" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Blood Group" id="bloodgroup" name="bloodgroup" class="form-control mb" required>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div id="address" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="h_no"  id="h_no"  placeholder="H-no" class='form-control mb text_tuition_fees_total' required/>
                               
                                </div>
                                
                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">STREET/VILLAGE</label>
                                    <input type='text' name='village' id='village' placeholder="STREET/VILLAGE" class='form-control mb' >
                                </div>

                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">MANDAL/AREA</label>
                                    <input type='text' name='mandal'  id='mandal' placeholder="MANDAL" class='form-control mb' >
                                </div>
                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">DISTRICT</label>
                                    <input type='text' name='district' id='district' placeholder="DISTRICT" class='form-control mb' >
                                </div>
                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">STATE</label>
                                    <input type='text' name='state' id='state' placeholder="STATE" class='form-control mb' >
                                </div>
                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">PIN CODE</label>
                                    <input type='text' name='pincode' id='pincode' placeholder="PIN" class='form-control mb' >
                                </div>
                            </div>
                            <br />
                        ...
                        <div id="family" class="tab-pane fade">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="father" id="father" placeholder="Father Name" class='form-control mb' required/>
                               
                                </div>
                                
                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">Mother Name</label>
                                    <input type='text' name='mother' id='mother' placeholder="Mother Name" class='form-control mb' >
                                </div>

                                <div class="col-md-6">
                                   <label class="text-uppercase f-16">Spouse Name</label>
                                    <input type='text' name='spouse' id='spouse' placeholder="Spouse Name" class='form-control mb' >
                                </div>
