<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">Inventory Transfer
                </h2>
                <div class="row">
                    <div class="col-md-12">
                        <form method="post" action="<?php echo base_url('Inventory/transferInventory') ?>">
                            <div class="row">
                                <?php
                               ...
                               <?php if($_GET['inventorydetailsid'] ==null){
                                ?>
                               
                                <div class="col-md-2">
                                    <label class="text-uppercase text-sm">Approved Quantity</label><br />
                                    <?php echo $inventory->quantity ?>
                                </div>
                                <div class="col-md-2">
                                    <label class="text-uppercase text-sm">delivered_quantity</label><br />
                                    <?php echo $inventory->delivered_quantity ?>
                                </div>
                                <?php } ?>
                                <div class="col-md-2">
                                ...
                                }else
                                {
                                    ?>
                                    <div class="col-md-3">
                                    <label class="text-uppercase text-sm">Transfer</label><br />
                            ...
                            <div class="col-md-12" id="div_print" style="display:none;">
                                        <div class="scale">
                                            ...
                                            <span style="margin-left:200px;">WareHouse-in-charge</span>
