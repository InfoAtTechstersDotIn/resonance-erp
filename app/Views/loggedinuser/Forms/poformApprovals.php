<div class="content-wrapper">
    <div class="container-fluid">
        <?php if ($_SESSION['rights'][array_search('PaymentApproval', array_column($_SESSION['rights'], 'operationname'))]->_view == 1) : ?>
            <div class="row">
                <div class="col-md-12">
                    <h2 class="page-title">Purchase Order Form Approvals</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <table id="tblpaymentApproval" class="DataTable table table-striped">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><a href="PoformApprovals/<?php echo $result->id ?>"><?php echo $result->id ?></a></td>
                                            ...
                                            <td>
                                                <?php if($result->purchase_order_status == "created"){
                                                    ?>
                                                ...
                                                <?php }
                                                if($result->purchase_order_status == "approved"){
                                                    $db = db_connect();
...
<script>
    ...
    function approveFormRequest(form_group_id, anchor) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('forms/PoGroupApprovalflow') ?>",
            data: {
                approveform: true,
